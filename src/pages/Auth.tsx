...
const Auth = () => {
  ...
  if (!isInitialized || loading) {
    return <div className="min-h-screen bg-gradient-to-br from-muted/20 to-muted/50 flex items-center justify-center">
  ...
  return <div className="min-h-screen bg-gradient-to-br from-primary/5 via-accent/5 to-secondary/5">
      <Header />
      <div className="container mx-auto px-4 py-8 sm:py-16 lg:py-24">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Portal</h1>
