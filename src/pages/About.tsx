    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-gradient-to-br from-muted/20 via-background to-muted/10">
        <div className="container mx-auto px-4">
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <h2 className="text-4xl font-bold text-foreground">
                  Nurturing Musical Excellence Since 2014
                </h2>
              </div>
          ...
          <div className="bg-gradient-to-r from-primary/10 via-accent/10 to-secondary/10 rounded-3xl p-12 text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              To provide world-class music education that inspires creativity, builds confidence, 
              and develops lifelong musical skills. We are committed to creating a supportive 
              environment where every student can discover their unique musical voice and reach 
