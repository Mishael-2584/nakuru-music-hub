    ...
    <div className="flex-1 pt-32 lg:pt-36 pb-16 px-4 sm:px-8 lg:px-32">
      <Card className="max-w-4xl mx-auto shadow-2xl border-0 border-l-8 border-primary bg-white/90">
        <CardHeader className="text-center">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground mb-4">Find answers to common questions about our programs, enrollment, and more. If you need further assistance, please <a href="mailto:info@damonmusicacademy.co.ke" className="text-blue-600 underline">contact us</a> or use the chat below.</p>
        </CardHeader>
        <CardContent>
