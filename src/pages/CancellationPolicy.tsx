  ...
  <div className="min-h-screen bg-muted/50 py-12 px-2">
    <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-3xl border-l-8 border-primary/80 p-8 relative overflow-hidden">
      ...
      <ul className="list-disc pl-6 mb-4 text-base">
        ...
        <li><b>Cancellation Limit:</b> A make-up lesson credit will not be issued for any cancellations beyond two (2) per billing period. The cancellation will be processed, but the student will be charged for the lesson as if it were a 'No-Show.'</li>
