-- Revert to the working quiz visibility migration (20251013000002)
-- Date: 2025-10-13
-- The last migration (20251013000003) broke post visibility
-- Reverting to the second-to-last migration which was actually working correctly
