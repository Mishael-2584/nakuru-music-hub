-- Fix teacher profile notification triggers to use correct column names
-- This migration fixes the trigger functions to use 'notification_type' instead of 'type'
