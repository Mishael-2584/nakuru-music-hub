-- Debug quiz question matching in RPC function
-- Date: 2025-07-02
...
BEGIN
  ...
  LOOP
    -- Get question ID as text first
    question_id_text := answer_data->>'questionId';
    ...
    IF FOUND THEN
      ...
      ELSIF question_record.question_type = 'matching' THEN
        -- Get student's matching pairs
        matching_pairs_data := COALESCE(answer_data->'matchingPairs', '[]'::jsonb);
