...
BEGIN
  ...
  LOOP
    INSERT INTO quiz_questions (
      ...
      COALESCE((question_data->>'has_image_attachment')::BOOLEAN, false),
      question_data->>'image_url',
      question_data->>'image_filename'
...
GRANT EXECUTE ON FUNCTION create_quiz(UUID, TEXT, TEXT, INTEGER, BOOLEAN, BOOLEAN, INTEGER, INTEGER, TIMESTAMPTZ, TEXT, BOOLEAN) TO authenticated;
